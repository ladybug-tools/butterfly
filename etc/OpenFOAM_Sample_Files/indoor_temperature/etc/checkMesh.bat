...
echo .
docker exec -i e7a36e8e9eeb su - ofuser -c "cd /home/ofuser/workingDir/butterfly/indoor_temperature; checkMesh > >(tee etc/checkMesh.log) 2> >(tee etc/checkMesh.err >&2)"