...
echo .
docker exec -i e7a36e8e9eeb su - ofuser -c "cd /home/ofuser/workingDir/butterfly/outdoor_airflow; simpleFoam  > >(tee etc/simpleFoam.log) 2> >(tee etc/simpleFoam.err >&2)"