...
ghenv.Component.Name = "Butterfly_Load Residuals"
ghenv.Component.NickName = "loadResiduals"
...
if _name:
    logFile = 'c:/users/{}/butterfly/{}/etc/simpleFoam.log'.format(os.getenv("USERNAME"), _name)
    text = tail(logFile).split("\nTime =")[-1].split('\n')
